...
| SG-002 Create human source authorities | IN_PROGRESS | SG-001 | CURRENT_STATE/SUIVI/NEXT_ACTION/DECISIONS/TASKS/PROGRAM |
| SG-003 Create machine source projections | PENDING | SG-002 | current/checkpoint/handoff/tasks JSON |
| SG-004 Enforce source-state validation | PENDING | SG-003 | validator + Governance CI |
| SG-005 Prevent client leakage | PENDING | SG-004 | directory removal + bootstrap self-test |
...
`SG-002_CREATE_SOURCE_AUTHORITIES`
